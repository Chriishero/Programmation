...
class DecisionTree:
    def __init__(self, max_features="sqrt", max_depth=None, min_sample_leaf=10, min_sample_split=5):
...
class RandomForest:
    def __init__(self, n_estimators=10, max_features="sqrt", max_depth=None, min_samples_leaf=10, min_samples_split=5):
        self.model = DecisionTree(max_features, max_depth, min_samples_leaf, min_samples_split)
